...
namespace ForestProductTracker
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        {
            if (Session["isSession"] != null && Session["isSession"].Equals("True"))
            {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (RadioButtonList1.SelectedValue.Equals("ForestAuth"))
            {
                ...
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('You're not a registered user. Sign up!');", true);
