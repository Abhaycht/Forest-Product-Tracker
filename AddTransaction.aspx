...
<body>
    ...
    <a href="ForestAuthDashboard.aspx" class="w3-bar-item w3-button">
      ...
      <article>
        <header class="section background-primary text-center" style="padding-top: 7vh; padding-bottom: 5vh;">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1" style=" margin-top: 7vh;"> ADD TRANSACTION</h1>
         </header>
       </article>
